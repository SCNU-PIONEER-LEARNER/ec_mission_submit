...
4. [arm-gnu-toolchain-15.2.rel1-mingw-w64-x86_64](https://armkeil.blob.core.windows.net/developer/files/downloads/gnu/15.2.rel1/binrel/arm-gnu-toolchain-15.2.rel1-mingw-w64-x86_64-arm-none-eabi.zip) (需要手动配置全局环境变量)
